...
namespace AutoPost.AnimationCanvas.Utils
{
    public static class CollisionManager
    {
        ...
        {
            foreach (var otherElement in canvasElements)
            {
                BallElement? otherBall = otherElement as BallElement;
                if (otherBall != null && otherBall != ball && CheckCollision(ball, otherBall))
                {
